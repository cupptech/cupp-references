...
angular.module('app', ['ngRoute', 'ngSanitize', 'workout', 'WorkoutBuilder', 'mediaPlayer', 
    'ui.bootstrap', 'ngAnimate', 'LocalStorageModule', 'ngMessages'])
.config(function($routeProvider, $sceDelegateProvider, WorkoutServiceProvider){

    WorkoutServiceProvider.configure('workoutdb', 'Ot8wBkHUi5vWVDCzIOMmR0PYoFZUdtKI');
