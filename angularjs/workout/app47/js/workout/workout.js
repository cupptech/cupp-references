...
angular.module('workout')
	.controller('WorkoutController', ['$scope','$interval', '$location', 'workoutHistoryTracker', 'appEvents',
              function($scope, $interval, $location, workoutHistoryTracker, appEvents){
    ...
    $scope.onKeyPress = function($event){
      if (event.which === 80 || event.which === 112) { // 'p' or 'P' key to toggle pause and resume.
		...
		// use $watch
/*
		$scope.$watch('currentExerciseDuration', function(newVal){
